        ...
        <div class="container py-lg-5 py-md-4 py-2">
            ...
            <div class="row justify-content-center">
                <div class="col-lg-4 col-md-6 item mt-5">
                    <div class="card">
                        ...
                        <div class="card-body course-details">
                            ...
                            <a href="../../app/views/index1.html" class="course-desc">chicken curry
                            </a>
                ...
                <div class="col-lg-4 col-md-6 item mt-5">
                    <div class="card">
                        ...
                        <div class="card-body course-details">
                            ...
                            <a href="../../app/views/index4.html" class="course-desc">apple tart
                            </a>
                            <div class="course-meta mt-4">
                                <div class="meta-item course-lesson">
                                    <span class="fas fa-fire"></span>
                ...
                <div class="col-lg-4 col-md-6 item mt-5">
                    <div class="card">
                        ...
                        <div class="card-body course-details">
                            ...
                            <a href="../../app/views/index6.html" class="course-desc">tiramisu</a>
                            <div class="course-meta mt-4">
                                <div class="meta-item course-lesson">
                                    <span class="fas fa-fire"></span>
                ...
                <div class="col-lg-4 col-md-6 item mt-5">
                    <div class="card">
                        <div class="card-header p-0 position-relative">
                            <a href="../../app/views/index7.html" class="zoom d-block">
                                <img class="card-img-bottom d-block" src="../../public/assets/images/rec7.png" alt="Card image cap">
                            </a>
                        ...
                        <div class="card-body course-details">
                            ...
                            <a href="../../app/views/index7.html" class="course-desc">shrimp ceviche</a>
                            <div class="course-meta mt-4">
                                <div class="meta-item course-lesson">
                                    <span class="fas fa-fire"></span>
                ...
                <div class="col-lg-4 col-md-6 item mt-5">
                    <div class="card">
                        <div class="card-header p-0 position-relative">
                            <a href="../../app/views/index8.html" class="zoom d-block">
                                <img class="card-img-bottom d-block" src="../../public/assets/images/rec8.png" alt="Card image cap">
                            </a>
                        ...
                        <div class="card-body course-details">
                            ...
                            <a href="../../app/views/index8.html" class="course-desc">herb-crusted lamb chops</a>
                            <div class="course-meta mt-4">
                                <div class="meta-item course-lesson">
                                    <span class="fas fa-fire"></span>
                                    <span class="meta-value"> 700 kcal</span>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-lg-4 col-md-6 item mt-5">
                    <div class="card">
                        <div class="card-header p-0 position-relative">
                            <a href="../../app/views/index9.html" class="zoom d-block">
                                <img class="card-img-bottom d-block" src="../../public/assets/images/rec9.png" alt="Card image cap">
                            </a>
                        ...
                        <div class="card-body course-details">
                            ...
                            <a href="../../app/views/index9.html" class="course-desc">cherry clafoutis</a>
                            <div class="course-meta mt-4">
                                <div class="meta-item course-lesson">
                                    <span class="fas fa-fire"></span>
                                    <span class="meta-value"> 300 kcal</span>
                                </div>
                            </div>
                        </div>
                    </div>
